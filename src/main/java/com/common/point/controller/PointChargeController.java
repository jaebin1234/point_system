...
public class PointChargeController {
	...
	@PostMapping("/charge")
	public ResponseEntity<Response<PointChargeAndUseResponse>> postPointChargeCreate(@RequestBody PointChargeAndUseRequest pointChargeAndUseRequest) throws Exception {

		final PointChargeAndUseResponse pointChargeAndUseResponse = pointChargeService.postPointChargeCreateIF(pointChargeAndUseRequest);
